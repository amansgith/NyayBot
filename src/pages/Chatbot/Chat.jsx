...
import { Send, Paperclip, ShieldCheck, FileText, MessageCircle } from "lucide-react";
...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-yellow-300 to-orange-200">
      ...
      {messages.length === 0 && (
        <div className="text-center text-gray-900 italic mt-8 text-lg">
          🤖 Welcome to the Legal Advisor Chatbot!  
          <p className="text-gray-700">Ask your legal questions or upload a document for insights.</p>

          {/* Features Section */}
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 px-8">
            {/* Feature 1 - Legal Advice */}
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center transition transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-gray-900">AI Legal Advice</h3>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center transition transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Document Summarizer</h3>
            </div>
          </div>
        </div>
      )}
      ...
      {/* Chat Input */}
      <div className="sticky bottom-0 left-0 w-1/2 bg-white shadow-md p-3 flex rounded-lg mx-auto mb-2 border border-yellow-500">
        ...
        {/* Send Button */}
        <button className="cursor-pointer bg-yellow-700 text-white p-2 rounded-lg ml-2" onClick={sendMessage}>
          <Send size={20} />
        </button>
      </div>
    </div>
